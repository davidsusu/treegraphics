...
public class ViewportTest2 {
	...
	public static void main(String[] args) {
		...
		viewport.addDrawable(new TestPoint(valueX5, valueY5, 10, new Color(200, 100, 0)));
		...
		viewport.addDrawable(new TestLine(valueX3, valueY3, valueX4, valueY4, new Color(0, 0, 0)));

		viewport.addDrawable(new TestPoint(valueX3, valueY3, 10, new Color(0, 0, 255)));
		viewport.addDrawable(new TestPoint(valueX4, valueY4, 10, new Color(255, 0, 255)));
